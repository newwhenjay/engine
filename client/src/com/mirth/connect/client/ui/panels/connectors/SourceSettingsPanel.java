...
public class SourceSettingsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        setBorder(BorderFactory.createTitledBorder(
                ...
                I18n.t("connectors.sourceSettings.title", "Source Settings"),
                TitledBorder.DEFAULT_JUSTIFICATION,
                TitledBorder.DEFAULT_POSITION,
                new Font("Tahoma", 1, 11)));

        sourceQueueLabel = new JLabel(I18n.t("connectors.sourceSettings.sourceQueue", "Source Queue:"));

        sourceQueueComboBox = new MirthComboBox();
        sourceQueueComboBox.setModel(new DefaultComboBoxModel(new String[] {
                I18n.t("connectors.sourceSettings.queueOff", "OFF (Respond after processing)"),
                I18n.t("connectors.sourceSettings.queueOn", "ON (Respond before processing)") }));
        sourceQueueComboBox.setToolTipText(I18n.t("connectors.sourceSettings.sourceQueue.tooltip",
        ...
        queueWarningLabel = new JLabel(I18n.t("connectors.sourceSettings.queueUnsupported", "Queuing is not supported by the current message storage mode."));
        queueWarningLabel.setForeground(Color.RED);

        queueBufferSizeLabel = new JLabel(I18n.t("connectors.sourceSettings.queueBufferSize", "Queue Buffer Size:"));
        queueBufferSizeField = new MirthTextField();
        queueBufferSizeField.setDocument(new MirthFieldConstraints(0, false, false, true));
        queueBufferSizeField.setToolTipText(I18n.t("connectors.sourceSettings.queueBufferSize.tooltip",
        ...
        responseLabel = new JLabel(I18n.t("connectors.sourceSettings.response", "Response:"));
        ...
        responseComboBox.setToolTipText(I18n.t("connectors.sourceSettings.response.tooltip",
        ...
        processBatchLabel = new JLabel(I18n.t("connectors.sourceSettings.processBatch", "Process Batch:"));
        ButtonGroup processBatchButtonGroup = new ButtonGroup();

        processBatchYesRadio = new MirthRadioButton(I18n.t("connectors.sourceSettings.yes", "Yes"));
        processBatchYesRadio.setBackground(getBackground());
        processBatchYesRadio.setToolTipText(I18n.t("connectors.sourceSettings.processBatch.tooltip",
        ...
        processBatchNoRadio = new MirthRadioButton(I18n.t("connectors.sourceSettings.no", "No"));
        processBatchNoRadio.setBackground(getBackground());
        processBatchNoRadio.setToolTipText(I18n.t("connectors.sourceSettings.processBatch.tooltip",
                "<html>Select Yes to enable batch processing. Batch messages are only supported if<br>the source connector's inbound properties contains a <b>Batch</b> section.</html>"));
        ...
        batchResponseLabel = new JLabel(I18n.t("connectors.sourceSettings.batchResponse", "Batch Response:"));
        ButtonGroup batchResponseButtonGroup = new ButtonGroup();

        batchResponseFirstRadio = new MirthRadioButton(I18n.t("connectors.sourceSettings.first", "First"));
        batchResponseFirstRadio.setBackground(getBackground());
        batchResponseFirstRadio.setToolTipText(I18n.t("connectors.sourceSettings.batchResponse.tooltip",
        ...
        batchResponseLastRadio = new MirthRadioButton(I18n.t("connectors.sourceSettings.last", "Last"));
        batchResponseLastRadio.setBackground(getBackground());
        batchResponseLastRadio.setToolTipText(I18n.t("connectors.sourceSettings.batchResponse.tooltip",
                "<html>Each message in the batch contains its own response that is generated via the method selected above.<br> Select either the response from the first or last message in the batch to be sent back to the originating system.</html>"));
        batchResponseButtonGroup.add(batchResponseLastRadio);

        processingThreadsLabel = new JLabel(I18n.t("connectors.sourceSettings.maxProcessingThreads", "Max Processing Threads:"));

        processingThreadsField = new MirthTextField();
        processingThreadsField.setDocument(new MirthFieldConstraints(0, false, false, true));
        processingThreadsField.setToolTipText(I18n.t("connectors.sourceSettings.maxProcessingThreads.tooltip",
